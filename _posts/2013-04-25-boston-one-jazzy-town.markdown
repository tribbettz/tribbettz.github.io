...
<img class="img-responsive img-rounded rounded mx-auto d-block border postImg" src="{{ site.url }}{{ site.post_img_path }}/jazzy_boston.jpg" alt="Boston Skyline Night">
...
<!-- more -->
<img class="img-responsive img-rounded rounded mx-auto d-block border postImg" src="{{ site.url }}{{ site.post_img_path }}/colorful_door.jpg" alt="A colorful Boston door.">
...
<img class="img-responsive img-rounded rounded mx-auto d-block border postImg" src="{{ site.url }}{{ site.post_img_path }}/davis_homes.jpg" alt="Homes of Davis Square">
...
<img class="img-responsive img-rounded rounded mx-auto d-block border postImg" src="{{ site.url }}{{ site.post_img_path }}/boston_sidewalk.jpg" alt="Cobblestone Sidewalk">
